...
export default {
  ...
  methods :{
    getOppData(event){
      ...
      this.makeOppGraph();
      this.$router.push({name : 'Data', params : {opp : this.oppsData, oppName : this.oppName, oppAssetData: this.oppsAssetData}});
    }, 
    makeOppTimeline(){
    ...
    makeOppGraph(){
      ...
      this.oppsAssetData['xAxis'] = xAxis;
      this.oppsAssetData['dataSet'] = dataSet;
    }, 
